...
class IDecode {
    ...
    CSRRWI  ->  List(Y,  BR_N  , OP1_X  , OP2_IMM , IMM_Z  , ALU_COPY1, WB_CSR, REN_1, MEN_0, M_X ,  MT_X /*,CSR.W*/),
    CSRRSI  ->  List(Y,  BR_N  , OP1_X  , OP2_IMM , IMM_Z  , ALU_COPY1, WB_CSR, REN_1, MEN_0, M_X ,  MT_X /*,CSR.S*/),
    CSRRCI  ->  List(Y,  BR_N  , OP1_X  , OP2_IMM , IMM_Z  , ALU_COPY1, WB_CSR, REN_1, MEN_0, M_X ,  MT_X /*,CSR.C*/),
...
class IntCtrlSigs extends Bundle {
        ...
        ): IntCtrlSigs =
    {
        ...
        val sigs = {
            Seq(legal, br_type, alu_op1, alu_op2, imm_type, alu_func, wb_sel, rf_wen, mem_en, mem_wr, mask_type)
        }
