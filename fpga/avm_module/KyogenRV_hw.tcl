...
add_fileset_file kyogenrv_fpga_avalonMM.sv SYSTEM_VERILOG PATH kyogenrv_fpga_avalonMM.sv {IS_CONFIGURATION_PACKAGE TOP_LEVEL_FILE}
add_fileset_file KyogenRVCpu.v VERILOG PATH ../chisel_generated/KyogenRVCpu.v IS_CONFIGURATION_PACKAGE
...
add_interface_port avalon_inst_master w_imem_data writedata Output 32
add_interface_port avalon_inst_master w_imem_data_byteenable byteenable Output 4
add_interface_port avalon_inst_master w_imem_data_req write Output 1


# 
# connection point expc
# 
add_interface expc conduit end
set_interface_property expc associatedClock clock
set_interface_property expc associatedReset ""
set_interface_property expc ENABLED true
set_interface_property expc EXPORT_OF ""
set_interface_property expc PORT_NAME_MAP ""
set_interface_property expc CMSIS_SVD_VARIABLES ""
set_interface_property expc SVD_ADDRESS_GROUP ""

add_interface_port expc ex_pc_addr readdata Output 32
